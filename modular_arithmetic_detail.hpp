...
//#if CUTRIALDIVE_IS_CUDA
    ...
    CUTRIALDIVE_DEVICE uint64_t modnby1(uint64_t * n, uint64_t nlen, uint64_t d);
    CUTRIALDIVE_DEVICE uint64_t modnby1(uint64_t * n, uint64_t nlen, uint64_t d, uint64_t rnd);
    template <size_t N>
    CUTRIALDIVE_DEVICE uint64_t modnby1(uint64_t (&n) [N], uint64_t d);
